...
import { pushToCloud, mergeOnLogin } from '../utils/sync.js'
  ...
  useEffect(() => {
    return onAuthStateChanged(auth, async (firebaseUser) => {
      ...
      if (firebaseUser) {
        ...
        // Called every popup open: flushes any pending background writes,
        // pulls fresh cloud data, merges both directions, pushes result back.
